""" Create an HTML page listing my favourite movies """
#  07/15/15     Program created
#  07/18/15     Updated comments and formatting
#
#  Description: Create and display an HTML page listing my favourite movies.
#               Users can click on the poster for more movie details or
#               watch a movie trailer by pressing the 'Watch Trailer' button.
#
...
#  Create movie list
def create_movies():
    """ Create and return a my movie list """
    ...
    die_hard = media.Movie(
        "Die Hard",
        "John McClane, officer of the NYPD, tries to save wife Holly Gennaro \
        and several others, taken hostage by German terrorist Hans Gruber \
    ...
    terminator_2 = media.Movie(
        ...
        must now protect her young son, John Connor, from a more advanced \
    ...
    zoolander = media.Movie(
        "Zoolander",
        "At the end of his career, a clueless fashion model is brainwashed \
    ...
    kung_fu_hustle = media.Movie(
        ...
        the notorious 'Axe Gang' while residents of a housing complex \
        exhibit extraordinary powers in defending their turf.",
    ...
    raiders_of_the_lost_ark = media.Movie(
        ...
        "Archaeologist and adventurer Indiana Jones is hired by the US \
    ...
    starship_troopers = media.Movie(
        "Starship Troopers",
        "Humans in a fascistic, militaristic future do battle with giant \
        alien bugs in a fight for survival.",
        "https://upload.wikimedia.org/wikipedia/en/d/df/Starship_Troopers_-_movie_poster.jpg",  # noqa
    ...
    movie_list = [
        toy_story, avatar, die_hard, terminator_2, zoolander,
        kung_fu_hustle, raiders_of_the_lost_ark, starship_troopers,
        fight_club
        ]
...
#  Grab movie list from create_movies() and Render the page
